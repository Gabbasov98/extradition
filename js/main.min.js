...
$("._toggle-menu").click((function(){$(".header").toggleClass("_open"),$("body").toggleClass("fixed-body")})),$(".header .menu-item-has-children>a").click((function(e){window.innerWidth>992||(e.preventDefault(),$(this).parents(".menu-item-has-children").toggleClass("_open"),$(this).siblings(".sub-menu").slideToggle())}));
...
$(window).scroll((function(){$("._anchor").each((function(t,e){let a=$(e).offset().top,i=a+$(e).height(),n=$(window).scrollTop(),o=$(e).attr("id");n>a&&n<i&&($(".text-nav__link._active").removeClass("_active"),$('.text-nav__link[href="#'+o+'"]').addClass("_active"))}))}));
