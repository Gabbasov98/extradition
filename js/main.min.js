function setLabelPlace(){document.querySelectorAll(".fg").forEach(t=>{let e=t.querySelector("input,textarea");function i(){""!==e.value?t.classList.add("_filled"):t.classList.remove("_filled")}i(),e.onchange=()=>{i()}})}$("._tab").click((function(){let t=$(this).parents("._tabs-parent"),e=$(this).attr("data-tab");$(t).find("._tab").removeClass("_active"),$(this).addClass("_active"),$(t).find(".tab-content").removeClass("_active"),$(t).find("."+e).addClass("_active")})),$(".tel-input input").intlTelInput({initialCountry:"ru",utilsScript:"js/utils.js"}),setLabelPlace(),$(".footer-nav__show").click((function(){window.innerWidth<=576&&($(this).parents(".footer-nav").toggleClass("_active"),$(this).siblings(".footer-nav__hidden").slideToggle())}));
$(".lang__show").click((function(){$(this).parents(".lang").toggleClass("_open")})),$(document).mouseup((function(e){let n=$(".lang");n.is(e.target)||0!==n.has(e.target).length||$(n).hasClass("_open")&&$(n).removeClass("_open")})),$("._toggle-menu").click((function(){$(".header").toggleClass("_open"),$("body").toggleClass("fixed-body")})),$(".header .menu-item-has-children>a").click((function(e){window.innerWidth>992||(e.preventDefault(),$(this).parents(".menu-item-has-children").toggleClass("_open"),$(this).siblings(".sub-menu").slideToggle())}));
...
function fixStickyMenu(){let n=document.querySelector(".country-info__col2");n&&(console.log(),n.getBoundingClientRect().top<=0?$(".m-page").addClass("_fix-sticky-menu"):$(".m-page").removeClass("_fix-sticky-menu"))}$(".country-list__more").click((function(){$(".country-list").toggleClass("_open")})),$(".qa-card__show").click((function(){let n=$(this).parents(".qa-card");$(n).hasClass("_open")?($(".qa-card").removeClass("_open"),$(".qa-card__hidden").slideUp()):($(".qa-card").removeClass("_open"),$(".qa-card__hidden").slideUp(),$(n).addClass("_open"),$(n).find(".qa-card__hidden").slideDown())})),$(".country-nav__current").html($(".country-nav__item._active").html()),$(".country-nav__show").click((function(){$(".country-nav").toggleClass("_open")})),$(".country-nav__bg").click((function(){$(".country-nav").toggleClass("_open")})),fixStickyMenu(),$(window).scroll((function(){fixStickyMenu()})),$(window).on("load resize",(function(){$(window).width()<=992&&$(window).width()>=576?$(".media-info__items").insertAfter(".media-info__grid"):$(".media-info__items").insertAfter(".media-info .text")}));
$(".text-nav__link").click((function(){$(".text-nav__link._active").removeClass("_active"),$(this).addClass("_active")}));
