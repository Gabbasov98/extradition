$("._tab").click((function(){let t=$(this).parents("._tabs-parent"),e=$(this).attr("data-tab");$(t).find("._tab").removeClass("_active"),$(this).addClass("_active"),$(t).find(".tab-content").removeClass("_active"),$(t).find("."+e).addClass("_active")}));let telInputs=document.querySelectorAll(".tel-input input");function setLabelPlace(){document.querySelectorAll(".fg").forEach(t=>{let e=t.querySelector("input,textarea");function a(){""!==e.value?t.classList.add("_filled"):t.classList.remove("_filled")}a(),e.onchange=()=>{a()}})}telInputs.forEach(t=>{window.intlTelInput(t,{initialCountry:"ru",separateDialCode:!0})}),setLabelPlace(),$(".footer-nav__show").click((function(){window.innerWidth<=576&&($(this).parents(".footer-nav").toggleClass("_active"),$(this).siblings(".footer-nav__hidden").slideToggle())}));
